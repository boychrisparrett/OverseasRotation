...
class Experience:
    ###############################################################################
    def __init__(self): self.experience = {}
    def incSkill(self,kw): pass
    def decSkill(self,kw): pass
    def add(self,exp): pass
    def subtract(self,exp): pass     
    ...
    def getSkillArray(self): 
        return [self.experience[v] for v in self.experience]
